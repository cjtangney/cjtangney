...
function NotFound404Page() {
  return (
    ...
    >
      <div className="h-screen w-screen grid relative place-items-center">
        <div className="border-2 border-[var(--border-c-default)] rounded-lg overflow-hidden relative h-[clamp(240px,_80%,_768px)] w-[clamp(320px,_70%,_1024px)]">
          <div className="border-2 border-[var(--border-c-default)] absolute left-[-2px] top-[-2px] rounded-t-lg grid content-center px-3 w-[calc(100%+4px)] h-[48px]">
          ...
          <div className="absolute w-full left-0 top-[46px] bg-[var(--bg-c-dark)] grid items-center justify-center h-[calc(100%-46px)]">
