...
import { FakeDesktopWindow } from "~/components/FakeDesktopWindow";
        ...
        <FakeDesktopWindow windowPaneStyles='bg-rainbow-inverted animated'>
          <div className="grid place-items-center gap-2">
            ...
            <div className="text-center grid gap-4">
              <Heading className="invert" level={1}>Ohno!</Heading>
              <Text className="invert">You've made a wrong turn!</Text>
              <ButtonLink href="/" variant="inverted" className="block text-center font-medium mt-10 !px-2 !py-1" >
                Go Home&nbsp;&nbsp;&nbsp;🏠
              </ButtonLink>
            </div>
            <Text className="text-center text-xs !mt-0 !mb-0 invert">
